...
<template>
  <div class="mx-28">
    ...
    <div class="grid grid-cols-8 my-8 gap-y-4">
      ...
      <div class="row-start-2 col-start-5 col-span-4 space-y-4">
        <router-link class="block" to="/proyectos/36daysoftype">
          36 Days of type
        </router-link>
        <router-link class="block" to="/proyectos/Timi-en-la-oscuridad">
      ...
      <div class="row-start-4 col-start-5 col-span-4 space-y-5">
        ...
        <router-link class="block" to="/proyectos/Ancestral">
          Ancestral
        </router-link>
        <router-link class="block" to="/proyectos/Web-gpb">
          Web GPB
        </router-link>
        <router-link class="block" to="/proyectos/Preparados">
          Preparado
        </router-link>
        <router-link class="block" to="/proyectos/Mil-historias">
          Mil historias
        </router-link>
      </div>
      ...
      <div class="row-start-6 col-start-5 col-span-4 space-y-4">
        <router-link class="block" to="/proyectos/Mestizo">
          Mestizo
        </router-link>
