...
<template>
  <img alt="Banner Ancestral" width="100%" class="max-w-1920 mx-auto" src="../assets/img/ancestral/banner-ancestral.png" />
  ...
  <OpeningTitle>
    ...
    <template #description>
      Ilustración, Diseño de personajes, Editorial
    </template>
  </OpeningTitle>
  ...
  <div class="max-w-1920 mx-auto">
    ...
    <div class="grid grid-cols-8 gap-2 mx-8 mb-24">
      <div class="col-span-3 row-start-1">
        <img alt="Foto" width="100%" height="100%" src="../assets/img/ancestral/foto01.png" />
      </div>
      <div class="col-span-3 row-start-2">
        <img alt="Foto" width="100%" height="100%" src="../assets/img/ancestral/foto02.png" />
      </div>
      <div class="col-span-5 row-span-2">
        <img alt="Foto" width="100%" height="100%" src="../assets/img/ancestral/foto03.png" />
      </div>
    </div>
    ...
    <div class="grid grid-cols-8 mx-8 gap-x-2">
      ...
      <p class="col-start-2 col-span-6 mt-8 mb-12">
        ...
        la investigación y registro desarrollado por el chef Cipactli para FAO El Salvador. Trabajar de manera
        multidisciplinaria y colaborativa es un componente del diseño flexible como parte fundamental en este proyecto.
      </p>
    ...
    <div class="my-16 text-center">
      ...
      <p>Fotografía y Post-producción_Otoniel López</p>
      <p>Dirección y Food-styling_Francisco Rivas</p>
      <p>Cocina y Coordinación_Chef Jorge Cipactli</p>
    </div>
  </div>
</template>
